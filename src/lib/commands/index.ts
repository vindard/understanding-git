...
import { parseCommandLine, extractRedirection } from './parsing';
...
// Re-export pure parsing functions for convenience
export { parseCommandLine, extractRedirection } from './parsing';
